...
async def notify_customer_quote_ready(
    ...
    *,
    ...
    doc = build_notification_doc(
        ...
        target_url=f"/dashboard/quotes/{quote_id}",
...
async def notify_customer_invoice_issued(
    ...
    *,
    ...
    doc = build_notification_doc(
        ...
        target_url=f"/dashboard/invoices/{invoice_id}",
        recipient_user_id=customer_user_id,
        entity_type="invoice",
...
async def notify_customer_order_dispatched(
    ...
    *,
    ...
    doc = build_notification_doc(
        ...
        target_url=f"/dashboard/orders/{order_id}",
        recipient_user_id=customer_user_id,
        entity_type="order",
        entity_id=order_id,
        priority="high",
...
async def notify_customer_service_status_updated(
    ...
    *,
    ...
    doc = build_notification_doc(
        ...
        target_url=f"/dashboard/service-requests/{service_request_id}",
        recipient_user_id=customer_user_id,
...
async def notify_customer_site_visit_scheduled(
    ...
    *,
    ...
    doc = build_notification_doc(
        ...
        target_url="/dashboard/service-requests",
        recipient_user_id=customer_user_id,
