                ...
                <tr>
                    <td style="background: #f9f9f9; padding: 30px; border-radius: 0 0 10px 10px;">
                        ...
                        <p style="text-align: center;">
                            <a href="https://action-hub-47.preview.emergentagent.com/products" style="display: inline-block; background: #D4A843; color: #2D3E50; padding: 12px 30px; text-decoration: none; border-radius: 25px; font-weight: bold;">Start Shopping</a>
                        </p>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="max-width: 600px; margin: 0 auto;">
                ...
                <tr>
                    <td style="background: #f9f9f9; padding: 30px; border-radius: 0 0 10px 10px;">
                        ...
                        <p style="text-align: center;">
                            <a href="https://action-hub-47.preview.emergentagent.com/orders/{order_id}" style="display: inline-block; background: #D4A843; color: #2D3E50; padding: 12px 30px; text-decoration: none; border-radius: 25px; font-weight: bold;">Track Your Order</a>
                        </p>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="background: #f9f9f9; padding: 30px; border-radius: 0 0 10px 10px;">
                        ...
                        <p style="text-align: center; margin-top: 30px;">
                            <a href="https://action-hub-47.preview.emergentagent.com/orders/{order_id}" style="display: inline-block; background: #D4A843; color: #2D3E50; padding: 12px 30px; text-decoration: none; border-radius: 25px; font-weight: bold;">View Order Details</a>
                        </p>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="background: #f9f9f9; padding: 20px; border-radius: 0 0 10px 10px;">
                        ...
                        <p style="text-align: center; margin-top: 20px;">
                            <a href="https://action-hub-47.preview.emergentagent.com/admin/orders" style="display: inline-block; background: #D4A843; color: #2D3E50; padding: 10px 25px; text-decoration: none; border-radius: 20px; font-weight: bold;">View in Admin</a>
                        </p>
                    </td>
                </tr>
            </table>
                ...
                <tr>
                    <td style="background: #f9f9f9; padding: 20px; border-radius: 0 0 10px 10px;">
                        ...
                        <p style="text-align: center; margin-top: 20px;">
                            ...
                            <a href="https://action-hub-47.preview.emergentagent.com/admin/maintenance" style="display: inline-block; background: #D4A843; color: #2D3E50; padding: 10px 20px; text-decoration: none; border-radius: 20px; font-weight: bold; margin: 5px;">View All</a>
                        </p>
                    </td>
                </tr>
            </table>
