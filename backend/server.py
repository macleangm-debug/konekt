...
from vendor_ops_routes import router as vendor_ops_router
...
app.include_router(vendor_ops_router)
...
from routes.team_performance_routes import router as team_performance_router
...
from vendor_agreement_routes import admin_router as vendor_agreement_admin_router, vendor_router as vendor_agreement_vendor_router, _load_persisted_version as _load_vendor_agreement_version
app.include_router(vendor_agreement_admin_router)
app.include_router(vendor_agreement_vendor_router)

@app.on_event("startup")
async def _load_agreement_version_on_startup():
    try:
        await _load_vendor_agreement_version()
    except Exception:
        pass
...
from group_deal_routes import router as group_deal_admin_router, public_router as group_deal_public_router, customer_router as group_deal_customer_router
app.include_router(group_deal_admin_router)
app.include_router(group_deal_public_router)
app.include_router(group_deal_customer_router)
...
from routes.admin_finance_routes import router as admin_finance_router
