...
async def create_campaign(payload: dict):
    ...
    campaign = {
        ...
        "vendor_best_price": float(payload.get("vendor_best_price") or 0),
        "funding_source": payload.get("funding_source", "internal"),
        "vendor_involved": payload.get("funding_source") == "vendor",
