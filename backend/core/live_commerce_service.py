    ...
    async def finance_queue(self, customer_query: Optional[str] = None, status_filter: Optional[str] = None) -> List[Dict[str, Any]]:
        ...
        for proof in rows:
            ...
            item = {
                ...
                "payer_phone": proof.get("payer_phone") or proof.get("phone") or contact_phone,
                "payer_email": proof.get("payer_email") or contact_email,
                "contact_phone": contact_phone,
                "company_name": company_name,
                "payment_reference": payment_reference,
                "source": "public" if proof.get("is_guest_submission") or proof.get("source") == "guest_payment_proof" else "account",
