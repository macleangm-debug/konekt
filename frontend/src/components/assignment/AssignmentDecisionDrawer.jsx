...
import { X, Box, Truck, AlertTriangle, CheckCircle2, Info } from "lucide-react";
...
export default function AssignmentDecisionDrawer({ orderId, open, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end" data-testid="assignment-decision-drawer">
      <div className="fixed inset-0 bg-black/30" onClick={onClose} />
      <div className="relative w-full max-w-lg bg-white shadow-xl overflow-y-auto">
        <div className="sticky top-0 bg-white border-b px-5 py-4 flex items-center justify-between z-10">
          <h2 className="text-base font-semibold text-slate-900">Assignment Reasoning</h2>
          <button onClick={onClose} className="p-1 hover:bg-slate-100 rounded" data-testid="close-assignment-drawer">
            <X className="h-4 w-4" />
          </button>
        </div>
