...
export default function ServiceHeroPanel({ accountMode = false }) {
  return (
    <section className="bg-white border-b" data-testid="service-hero-panel">
        ...
        <div className="grid lg:grid-cols-[1fr_0.95fr] gap-10 items-center">
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 mt-8">
              ...
              >
                {accountMode ? "Request Business Pricing" : "Explore All Services"}
              </Link>
            </div>
          </div>

          <div className="grid sm:grid-cols-2 gap-4">
            <div className="rounded-3xl bg-white border p-6 hover:shadow-md transition">
