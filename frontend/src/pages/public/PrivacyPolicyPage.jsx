    ...
    <div className="max-w-4xl mx-auto px-6 py-10" data-testid="privacy-policy-page">
      ...
      <div className="prose prose-slate max-w-none space-y-6">
        ...
        <section>
          ...
          <p className="text-slate-600 leading-relaxed">
            We use your order information internally to process, source, and deliver your products.
            We do not sell your personal information to third parties. Information is shared only
            as required to complete your order and provide customer support.
