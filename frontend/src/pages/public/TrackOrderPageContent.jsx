...
import {
  ...
  ArrowLeft, CreditCard, MapPin, ShoppingBag, ArrowRight, Mail,
} from "lucide-react";
...
export default function TrackOrderPageContent() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-10" data-testid="track-order-page">
      ...
      {/* Search Form */}
      <div className="rounded-2xl border bg-white p-6 mb-8" data-testid="track-search-form">
        <form onSubmit={handleSearch} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full rounded-xl bg-[#20364D] text-white px-6 py-3 font-semibold hover:bg-[#2a4a66] transition disabled:opacity-50"
      ...
      {/* Error State */}
      {error && (
        <div className="rounded-xl bg-red-50 border border-red-200 p-4 flex items-start gap-3 mb-6" data-testid="track-error">
          ...
          <div className="rounded-2xl border bg-white p-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div>
                ...
                <h2 className="text-2xl font-bold text-[#20364D] font-mono" data-testid="result-order-number">
              ...
              {[
                ...
                return (
                  <div key={step.key} className="flex gap-4">
                    ...
                    <div className="pb-6">
                      <p className={`font-medium ${done ? "text-[#20364D]" : "text-slate-400"}`}>{step.label}</p>
                      {step.time && (
      ...
      {/* Help section */}
      <div className="mt-8 rounded-2xl bg-slate-50 border p-6 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
          <a href="mailto:sales@konekt.co.tz"
            className="inline-flex items-center gap-2 rounded-xl bg-[#20364D] text-white px-5 py-2.5 font-semibold hover:bg-[#2a4a66] transition text-sm"
            data-testid="track-email-support">
            <Mail className="w-4 h-4" /> Email Support
          </a>
          <Link to="/help"
            className="inline-flex items-center gap-2 rounded-xl border border-[#20364D] text-[#20364D] px-5 py-2.5 font-semibold hover:bg-[#20364D] hover:text-white transition text-sm"
