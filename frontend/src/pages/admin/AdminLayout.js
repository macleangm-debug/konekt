...
const navItems = [
  ...
  { path: '/admin/partner-ecosystem', label: 'Partner Ecosystem', icon: Network, moduleKey: 'partners', highlight: true },
  { path: '/admin/partners', label: 'Partners List', icon: Users, moduleKey: 'partners' },
